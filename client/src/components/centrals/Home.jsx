...
function Home() {
  ...
  return (
    <>
      <animated.div style={{ ...heroAnimation, backgroundImage: 'url(https://img.daisyui.com/images/stock/photo-1507358522600-9f71e620c44e.webp)', ...bgAnimation, backgroundSize: 'cover' }} className="hero min-h-screen bg-gray-800">
        ...
        <div className="hero-content text-gray-200 text-center">
          <div className="max-w-md">
            ...
            <Link to="/login" className="btn bg-gray-600 hover:bg-gray-700 text-white">
              Enter Website
            </Link>
          </div>
        </div>
      ...
      <animated.div style={heroAnimation} className="hero bg-gray-700 min-h-screen">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          />
          <div>
            <h1 className="text-5xl font-bold text-gray-200">Box Office News!</h1>
      ...
      <footer className="footer bg-gray-800 text-gray-300 p-10">
        <aside>
          <svg
            width="50"
            height="50"
