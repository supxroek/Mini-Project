...
import Booking from "./components/ีuser-sections/Booking";
import Dashboard from "./components/ีuser-sections/Dashboard";
import ForgotPass from "./components/ีuser-sections/ForgotPass";
import QRcode from "./components/ีuser-sections/QRcode";
import Rooms from "./components/ีuser-sections/Rooms";
